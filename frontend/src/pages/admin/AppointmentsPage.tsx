...
function AppointmentMessageModal({
  ...
  const handleShare = () => {
    ...
    // whatsapp:// protocol opens the desktop/mobile app directly,
    // bypassing the wa.me landing page entirely.
    window.open(`whatsapp://send?phone=${digits}&text=${encoded}`, '_blank')
  }
